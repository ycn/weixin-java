 ...
 */
public class ScanCodeWaitMsgBuilder extends BaseBuilder<ScanCodeWaitMsgBuilder> {

    public ScanCodeWaitMsgBuilder() {

    }

    public ScanCodeWaitMsgBuilder key(String key) {
        if (!isEmpty(key))
            menu.key = key;
        return this;
    }
    ...
    protected WxMenuType getType() {
        return WxMenuType.SCANCODE_WAITMSG;
    }
