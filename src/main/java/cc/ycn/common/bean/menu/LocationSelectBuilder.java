 ...
 */
public class LocationSelectBuilder extends BaseBuilder<LocationSelectBuilder> {

    public LocationSelectBuilder() {

    }

    public LocationSelectBuilder key(String key) {
        if (!isEmpty(key))
            menu.key = key;
        return this;
    }
    ...
    protected WxMenuType getType() {
        return WxMenuType.LOCATION_SELECT;
    }
