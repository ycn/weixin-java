 ...
 */
public class ScanCodePushBuilder extends BaseBuilder<ScanCodePushBuilder> {

    public ScanCodePushBuilder() {

    }

    public ScanCodePushBuilder key(String key) {
        if (!isEmpty(key))
            menu.key = key;
        return this;
    }
    ...
    protected WxMenuType getType() {
        return WxMenuType.SCANCODE_PUSH;
    }
