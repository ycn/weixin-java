 ...
 */
public class PicSysPhotoBuilder extends BaseBuilder<PicSysPhotoBuilder> {

    public PicSysPhotoBuilder() {

    }

    public PicSysPhotoBuilder key(String key) {
        if (!isEmpty(key))
            menu.key = key;
        return this;
    }
    ...
    protected WxMenuType getType() {
        return WxMenuType.PIC_SYSPHOTO;
    }
